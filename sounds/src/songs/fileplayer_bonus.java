...
public class fileplayer_bonus {
    ...
    private static void playSingleNote(String note) {
        try {
            String filePath = "C:/Users/User/OneDrive/Documents/NEU_ASSIGNMENTS/INFO500/sounds/sounds/src/songs/Sounds/"+ note + ".wav"; // Replace with the actual file path
