...
public class Sound {
    ...
    private static void playSingleNote(String note) {
        try {
            String filePath = "C:\\Users\\User\\OneDrive\\Documents\\NEU_ASSIGNMENTS\\INFO500\\Assignment5_Multitreading-master\\src\\songs\\Sounds" + note + ".wav"; // Replace with the actual file path
